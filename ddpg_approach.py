...
env = simulator.Robot() #gym.make('FetchReach-v1')
action_size = 4
state_size = 15 #13
action_bound =  0.01 #env.action_space.high
batch_size = 128
import random
...
for ii in range(max_ep):
    ...
    overall_cumulative_reward.append(cumulative_reward)
    R_graph.append(R)
    R_graph_.append(R)
    ...
    #plot_rewards(overall_cumulative_reward)
